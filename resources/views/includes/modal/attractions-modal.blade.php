<!-- Modal -->
<div class="modal first fade" id="attractions_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        ...
        <h4 class="modal-title" id="exampleModalLabel">@lang('frontend.menu.attractions')</h4>
      </div>
      <div class="modal-body">
        <form id="dataModel" action="{{route('setting.admin.storeAttraction')}}" role="form" method="post"
          ...
          <div class="form-group">
            ...
            <div class="pre-img-box">
              <div class="input-f">
                <span class="image-s"><span id="main_width">770</span> X <span id="main_height">330</span>
