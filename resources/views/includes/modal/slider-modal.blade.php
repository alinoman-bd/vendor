<!-- Modal -->
<div class="modal first fade" id="slide_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header text-center">
        ...
        <h4 class="modal-title" id="exampleModalLabel">@lang('frontend.menu.slider')</h4>
      </div>
      <div class="modal-body">
        <form id="dataModel" action="{{route('setting.admin.storeSlier')}}" role="form" method="post"
          ...
          <div class="form-group">
            <label for="title" class="control-label">@lang('backend.modal.title.text'):</label>
            <input type="text" id="titleText" name="title_text" class="form-control">
          </div>
          <div class="form-group">
            <label for="title" class="control-label">@lang('backend.modal.button.text')Button text:</label>
            <input type="text" id="buttonText" name="button_text" class="form-control">
          </div>
          <div class="form-group">
            <label for="title" class="control-label">@lang('backend.modal.button.link'):</label>
            <input type="text" id="buttonLink" name="button_link" class="form-control">
          </div>
          ...
          <div class="form-group">
            ...
            <div class="pre-img-box">
              <div class="input-f">
                <span class="image-s"><span id="main_width">1920</span> X <span id="main_height">980</span>
